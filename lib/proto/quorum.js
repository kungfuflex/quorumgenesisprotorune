...
exports.RuneRangeInput = exports.RuneRange = void 0;
...
class RuneRangeInput$Type extends runtime_4.MessageType {
    constructor() {
        super("quorum.RuneRangeInput", [
            { no: 1, name: "outpoint", kind: "message", T: () => protorune_2.Outpoint },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* protorune.Outpoint outpoint */ 1:
                    message.outpoint = protorune_2.Outpoint.internalBinaryRead(reader, reader.uint32(), options, message.outpoint);
                    break;
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.outpoint)
            protorune_2.Outpoint.internalBinaryWrite(message.outpoint, writer.tag(1, runtime_1.WireType.LengthDelimited).fork(), options).join();
