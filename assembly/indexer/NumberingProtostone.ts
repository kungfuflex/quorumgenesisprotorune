...
export class NumberingProtostone extends Protostone {
  ...
  static fromProtostoneAndRanges(protostone: Protostone, ranges: BSTU128): NumberingProtostone {
    return new NumberingProtostone(protostone.fields, protostone.edicts, protostone.protocolTag)._setRanges(ranges);
  }
