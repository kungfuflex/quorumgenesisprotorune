...
export namespace quorum {
  ...
  export class ProposalId {
    ...
    // Decodes ProposalId from an ArrayBuffer
    static decode(buf: ArrayBuffer): ProposalId {
      return ProposalId.decodeDataView(new DataView(buf));
    }

    // Decodes ProposalId from a DataView
    static decodeDataView(view: DataView): ProposalId {
      const decoder = new __proto.SafeDecoder(view);
      const obj = new ProposalId();
      ...
      if (decoder.invalid()) return changetype<ProposalId>(0);
      return obj;
    } // decode ProposalId
    ...
    // Encodes ProposalId to the ArrayBuffer
    encode(): ArrayBuffer {
      return changetype<ArrayBuffer>(
        StaticArray.fromArray<u8>(this.encodeU8Array())
      );
    ...
    // Encodes ProposalId to the Array<u8>
    encodeU8Array(
      encoder: __proto.Encoder = new __proto.Encoder(new Array<u8>())
    ): Array<u8> {
      const buf = encoder.buf;
  ...
  export class Proposal {
    ...
    public voteIndex: u32;

    // Decodes Proposal from an ArrayBuffer
    static decode(buf: ArrayBuffer): Proposal {
      return Proposal.decodeDataView(new DataView(buf));
    }

    // Decodes Proposal from a DataView
    static decodeDataView(view: DataView): Proposal {
      const decoder = new __proto.SafeDecoder(view);
      ...
      while (!decoder.eof()) {
        ...
        switch (number) {
          case 1: {
            obj.quorumHeight = decoder.uint64();
            break;
          }
          case 2: {
            obj.quorumWeight = decoder.uint64();
            break;
          }
          case 3: {
            obj.choices.push(decoder.string());
            break;
          }
          case 4: {
            obj.voteIndex = decoder.uint32();
            break;
          }
      ...
      if (decoder.invalid()) return changetype<Proposal>(0);
      return obj;
    } // decode Proposal
    ...
    public size(): u32 {
      ...
      size +=
        this.quorumHeight == 0
          ? 0
          : 1 + __proto.Sizer.uint64(this.quorumHeight);
      size +=
        this.quorumWeight == 0
          ? 0
          : 1 + __proto.Sizer.uint64(this.quorumWeight);

      size += __size_string_repeated(this.choices);

      size +=
        this.voteIndex == 0 ? 0 : 1 + __proto.Sizer.uint32(this.voteIndex);

      return size;
    }

    // Encodes Proposal to the ArrayBuffer
    encode(): ArrayBuffer {
      return changetype<ArrayBuffer>(
        StaticArray.fromArray<u8>(this.encodeU8Array())
      );
    ...
    // Encodes Proposal to the Array<u8>
    encodeU8Array(
      encoder: __proto.Encoder = new __proto.Encoder(new Array<u8>())
    ): Array<u8> {
      const buf = encoder.buf;

      if (this.quorumHeight != 0) {
        encoder.uint32(0x8);
        encoder.uint64(this.quorumHeight);
      }
      if (this.quorumWeight != 0) {
        encoder.uint32(0x10);
        encoder.uint64(this.quorumWeight);
      }

      if (this.choices.length > 0) {
        for (let n: i32 = 0; n < this.choices.length; n++) {
          encoder.uint32(0x1a);
          encoder.uint32(this.choices[n].length);
          encoder.string(this.choices[n]);
        }
      }

      if (this.voteIndex != 0) {
        encoder.uint32(0x20);
        encoder.uint32(this.voteIndex);
      }
  ...
  export class Vote {
    public proposal: ProposalId = new ProposalId();
    public voteIndex: u32;

    // Decodes Vote from an ArrayBuffer
    static decode(buf: ArrayBuffer): Vote {
      return Vote.decodeDataView(new DataView(buf));
    }

    // Decodes Vote from a DataView
    static decodeDataView(view: DataView): Vote {
      const decoder = new __proto.SafeDecoder(view);
      const obj = new Vote();
      ...
      while (!decoder.eof()) {
        ...
        switch (number) {
          case 1: {
            const length = decoder.uint32();
            obj.proposal = ProposalId.decodeDataView(
              new DataView(
                decoder.view.buffer,
                decoder.pos + decoder.view.byteOffset,
                length
      ...
      if (decoder.invalid()) return changetype<Vote>(0);
      return obj;
    } // decode Vote
    ...
    public size(): u32 {
      ...
      if (this.proposal != null) {
        const f: ProposalId = this.proposal as ProposalId;
        const messageSize = f.size();
    ...
    // Encodes Vote to the ArrayBuffer
    encode(): ArrayBuffer {
      return changetype<ArrayBuffer>(
        StaticArray.fromArray<u8>(this.encodeU8Array())
      );
    ...
    encodeU8Array(
      ...
      if (this.proposal != null) {
        const f = this.proposal as ProposalId;
  ...
  export class QuorumProtoMessage {
    public proposal: Proposal | null;
    public vote: Vote | null;

    public __data: string = "";
    public __data_index: u8 = 0;

    static readonly DATA_PROPOSAL_INDEX: u8 = 1;
    static readonly DATA_VOTE_INDEX: u8 = 2;

    // Decodes QuorumProtoMessage from an ArrayBuffer
    static decode(buf: ArrayBuffer): QuorumProtoMessage {
      return QuorumProtoMessage.decodeDataView(new DataView(buf));
    }

    // Decodes QuorumProtoMessage from a DataView
    static decodeDataView(view: DataView): QuorumProtoMessage {
      const decoder = new __proto.SafeDecoder(view);
      const obj = new QuorumProtoMessage();
      ...
      while (!decoder.eof()) {
        ...
        switch (number) {
          case 1: {
            const length = decoder.uint32();
            obj.proposal = Proposal.decodeDataView(
              new DataView(
                decoder.view.buffer,
                decoder.pos + decoder.view.byteOffset,
                length
      ...
      if (decoder.invalid()) return changetype<QuorumProtoMessage>(0);
      return obj;
    } // decode QuorumProtoMessage

    public size(): u32 {
      let size: u32 = 0;

      if (this.proposal != null) {
        const f: Proposal = this.proposal as Proposal;
        const messageSize = f.size();
      ...
      if (this.vote != null) {
        const f: Vote = this.vote as Vote;
        const messageSize = f.size();
    ...
    // Encodes QuorumProtoMessage to the ArrayBuffer
    encode(): ArrayBuffer {
      return changetype<ArrayBuffer>(
        StaticArray.fromArray<u8>(this.encodeU8Array())
      );
    ...
    // Encodes QuorumProtoMessage to the Array<u8>
    encodeU8Array(
      encoder: __proto.Encoder = new __proto.Encoder(new Array<u8>())
    ): Array<u8> {
      const buf = encoder.buf;
      ...
      if (this.proposal != null) {
        const f = this.proposal as Proposal;
